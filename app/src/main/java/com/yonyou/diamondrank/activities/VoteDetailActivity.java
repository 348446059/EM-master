...
import com.yonyou.diamondrank.adapters.ListRecyclerAdapter;
...
//        }
        if (allFlag){
            ...
            okHttpGetData(userId,startTime,endTime, Utils.getUrl(this,AppConstants.ALL_VOTELIST_URL));
        }else{
            if (null!=userId){
                okHttpGetData(userId,startTime,endTime,Utils.getUrl(this,AppConstants.VOTELIST_URL));
            }else{
